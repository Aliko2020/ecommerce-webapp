...
export const Navbar = () => {
  ...
  return (
    <nav className="border-b bg-white">
        ...
        <div className="hidden lg:flex space-x-8">
          {navLinks.map(({ name, path }) => (
            <NavLink
              ...
              className={({ isActive }) =>
                `relative font-medium transition-colors duration-200 ${isActive
      ...
      {/* Mobile Sidebar */}
      <div
        className={`fixed top-0 left-0 h-full w-64 bg-[#0d0f16] text-white transform ${menuOpen ? "translate-x-0" : "-translate-x-full"
        ...
        <div className="flex flex-col space-y-6 mt-8 px-4">
          {navLinks.map(({ name, path }) => (
            <NavLink
              ...
              className={({ isActive }) =>
                `font-medium transition-colors duration-200 ${isActive ? "text-green-500" : "hover:text-red-400"
                }`
              }
            >
              {name}
